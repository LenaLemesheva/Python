...
def csv_data_open():      # 1 - показать все
    with open("Семинары/Онлайн/20.10.22/csv_data.csv", encoding='utf-8') as file:
...
def add_info(list):  # 2- добавление информации
    with open("Семинары/Онлайн/20.10.22/csv_data.csv", "a", encoding="utf8", newline='') as f:
...
def del_info(index):  # удаление информации
    ...
    print(list_csv)
    del list_csv[index]
    with open("Семинары/Онлайн/20.10.22/csv_data.csv", "w", encoding="utf8", newline='') as file:
